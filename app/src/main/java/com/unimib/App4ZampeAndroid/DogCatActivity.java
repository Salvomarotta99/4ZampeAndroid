...
public class DogCatActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private int[] PlaceholderListD = new int[]{R.drawable.placeholderdog1,
            R.drawable.placeholderdog2,R.drawable.placeholderdog3};

    private int[] PlaceholderListC = new int[]{R.drawable.placeholdercat,
    ...
    private void setQuestion() {
        ...
        if(questionList.get(0).getImgSrc().contentEquals("nullC")||questionList.get(0).getImgSrc().contentEquals("nullD")){
            final int random = new Random().nextInt(3);
            if(questionList.get(0).getImgSrc().contentEquals("nullC")){
                Picasso.get().load(PlaceholderListC[random]).into(imgView);
            }else{
                Picasso.get().load(PlaceholderListD[random]).into(imgView);
            }
                        ...
                        if (value == 0) {
                            switch (viewNum) {
                                ...
                                case 4:
                                    ...
                                    break;
                                case 5:
                                    if(questionList.get(questNum).getImgSrc().contentEquals("nullC")||questionList.get(questNum).getImgSrc().contentEquals("nullD")){
                                        final int random = new Random().nextInt(3);
